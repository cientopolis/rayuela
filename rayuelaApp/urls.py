...
urlpatterns = [
    ...
    path('process_score/', game_rules.process_score, name='process_score'),
    path('delete_score/<int:project_id>/<int:score_id>/', game_rules.delete_score, name='delete_score'),
    path('modify_score/<int:project_id>/<int:score_id>/', game_rules.modify_score, name='modify_score'),
    path('process_modify_score/', game_rules.process_modify_score, name='process_modify_score'),
    ...
    path('modify_collection_task/<int:project_id>/<int:collection_task_id>/', collection_tasks.modify_collection_task, name='modify_collection_task'),
    path('process_modify_collection_task/', collection_tasks.process_modify_collection_task, name='process_modify_collection_task'),
